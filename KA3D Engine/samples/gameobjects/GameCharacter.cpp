...
void GameCharacter::loadCharacterAnimation( lang::String statename, lang::String filename, lang::String endbehavior )
{
...
void GameCharacter::loadUpperBodyAnimation( lang::String statename, lang::String direction, lang::String filename, lang::String endbehavior )
{
