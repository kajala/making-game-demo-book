...
public:
	 ...
	 */
	DIPrimitive( const VertexFormat& fmt, int vertices, int indices );
	 ...
	 */
	void	setVertexPositions( int index, const math::float4* data, int count );
	 ...
	 */
	void	setVertexTransformedPositions( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexNormals( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexDiffuseColors( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexSpecularColors( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexTangents( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexBoneWeights( int index, const math::float4* data, int count );
	 ...
	 * @param count Vertex count.
	 */
	void	setVertexBoneIndices( int index, const math::float4* data, int count );
	 ...
	 */
	void	setVertexTextureCoordinates( int index, int layer, const math::float4* data, int count );
	 ...
	 */
	void	sortFrontToBack( const math::float3& refpos, const math::float4x4& worldtm,
				const math::float4x4* boneworldtm, int boneworldtmcount,
				SortBuffer& tmp );
	 ...
	 * @param tmp Temporary buffer used in sorting.
	 */
	void	sortBackToFront( const math::float3& refpos, const math::float4x4& worldtm,
				const math::float4x4* boneworldtm, int boneworldtmcount, 
				SortBuffer& tmp );
	...
	void 	setVertexData( VertexFormat::DataType dt, int index, 
				const math::float4* data, int count );
	 ...
	 * @param scale Scale for source data (applied before data usage).
	 * @param bias Offset to add to source data after scaling.
	 */
	void 	setVertexData( VertexFormat::DataType dt, int index, 
				const void* data, VertexFormat::DataFormat df, int count, 
				const math::float4& scale, const math::float4& bias );
	 ...
	 */
	void 	getVertexData( VertexFormat::DataType dt, int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexPositions( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexNormals( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexDiffuseColors( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexSpecularColors( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexTangents( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexBoneWeights( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Vertex count.
	 */
	void	getVertexBoneIndices( int index, math::float4* data, int count ) const;
	 ...
	 * @param count Texture coordinate count.
	 */
	void	getVertexTextureCoordinates( int index, int layer, math::float4* data, int count ) const;
	 ...
	 */
	void	getTriangleDistances( const math::float3& worldpos, const math::float4x4& worldtm, const math::float4x4* boneworldtm, int boneworldtmcount, uint16_t* trix, float* tridist, int tricount ) const;
	 ...
	 */
	void	findSplit( int maxbones, lang::Array<int>& faceset1, lang::Array<int>& faceset2 ) const;
...
private:
	...
	uint16_t				m_indexRangeBegin;
	uint16_t				m_indexRangeEnd;
	gr::VertexFormat		m_vf;
	uint8_t					m_usedBones;
