...
public:
	 ...
	 * must be set after Shader::begin() call.
	 ...
	 * Calls Shader::begin() in the constructor and Shader::end()
	 * in the destructor.
	 ...
	 * Calls Shader::beginPass() in the constructor and Shader::endPass()
	 * in the destructor.
	 * Use this class instead of the methods directly for exception-safety.
	 * @see Shader::begin
	 */
	 ...
	 */
	virtual void		setMatrix( ParamType param, const math::float4x4& value ) = 0;

	/**
	 * Sets custom shader 4x4 matrix parameter which is not defined in ParamType.
	 */
	virtual void		setMatrix( const char* name, const math::float4x4& value ) = 0;

	/**
	 * Sets shader 4x4 matrix array parameter.
	 */
	virtual void		setMatrixArray( ParamType param, math::float4x4** values, int count ) = 0;

	/**
	 * Sets shader 4-vector parameter.
	 */
	virtual void		setVector( ParamType param, const math::float4& value ) = 0;

	/**
	 * Sets custom shader 4-vector parameter which is not defined in ParamType.
	 */
	virtual void		setVector( const char* name, const math::float4& value ) = 0;
	 ...
	 */
	virtual math::float4x4	getMatrix( const char* name ) = 0;

	/**
	 * Gets shader vector parameter or 0 if texture not set.
	 */
	virtual math::float4	getVector( const char* name ) = 0;
	 ...
	 */
	virtual const lang::String&		name() const = 0;
