...
static int tri_tri_overlap_test_3d(float p1[3], float q1[3], float r1[3], 
			    float p2[3], float q2[3], float r2[3]);


static int coplanar_tri_tri3d(float  p1[3], float  q1[3], float  r1[3],
		       float  p2[3], float  q2[3], float  r2[3],
		       float  N1[3]);


static int tri_tri_overlap_test_2d(float p1[2], float q1[2], float r1[2], 
			    float p2[2], float q2[2], float r2[2]);


// static int tri_tri_intersection_test_3d(float p1[3], float q1[3], float r1[3], 
//				 float p2[3], float q2[3], float r2[3],
//				 int * coplanar, 
...
static int tri_tri_overlap_test_3d(float* p1, float* q1, float* r1, 
...
static int ccw_tri_tri_intersection_2d(float p1[2], float q1[2], float r1[2], 
				float p2[2], float q2[2], float r2[2]) {
...
static int tri_tri_overlap_test_2d( float* p1, float* q1, float* r1,
								   float* p2, float* q2, float* r2) {
...
bool IntersectionUtil::testTriangleTriangleOverlap( 
	const float2* a, const float2* b )
{
	return 0 != tri_tri_overlap_test_2d( 
		const_cast<float*>(&a[0].x), const_cast<float*>(&a[1].x), const_cast<float*>(&a[2].x),
		const_cast<float*>(&b[0].x), const_cast<float*>(&b[1].x), const_cast<float*>(&b[2].x) );
}

bool IntersectionUtil::testTriangleTriangleOverlap( 
	const float3* a, const float3* b )
{
	return 0 != tri_tri_overlap_test_3d( 
		const_cast<float*>(&a[0].x), const_cast<float*>(&a[1].x), const_cast<float*>(&a[2].x),
		const_cast<float*>(&b[0].x), const_cast<float*>(&b[1].x), const_cast<float*>(&b[2].x) );
}
