...
void Lines::addSphere( const math::float3x4& tm, float radius,
...
void Lines::addCylinder( const math::float3x4& tm, float radius, float height,
	const math::float4& color, int segments )
{
	assert( segments >= 4 );
