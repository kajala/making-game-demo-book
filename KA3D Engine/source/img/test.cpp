...
static void writePhongMap( const String& filename, float shininess, SurfaceFormat dstformat )
{
	...
	img::ImageWriter::write( filename, dstformat, data.begin(), w, h, w*fmt.bitsPerPixel()/8, fmt, paldata.begin(), palfmt );
}
...
static void savePNG24( const String& datapath )
{
	...
	img::ImageWriter::writePNG( PathName(datapath,"images/out-test-24b.png").toString(), 
...
static void savePNG8( const String& datapath )
{
	...
	img::ImageWriter::writePNG( PathName(datapath,"images/out-test-8b.png").toString(), 
		data.begin(), w, h, w*fmt.bitsPerPixel()/8, fmt, paldata.begin(), palfmt );
}
...
static void saveRandomDist( const String& datapath )
{
	...
	img::ImageWriter::writePNG( PathName(datapath,"images/out-random-dist.png").toString(), 
